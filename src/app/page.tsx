    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <main className="max-w-4xl w-full z-10 flex flex-col items-center gap-12 text-center">
        ...
        <section className="flex flex-col sm:flex-row gap-4 mt-8">
          <button className="px-10 py-4 bg-cyan-accent text-black font-bold uppercase tracking-widest rounded-sm hover:bg-white transition-all transform hover:scale-105 active:scale-95">
            Join the Takeover
          </button>
          <button className="px-10 py-4 glass border-white/20 text-white font-bold uppercase tracking-widest rounded-sm hover:bg-white/10 transition-all">
            System Specs
          </button>
        </section>
      </main>
